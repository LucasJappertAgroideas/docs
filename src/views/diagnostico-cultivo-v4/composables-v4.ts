// Composables y lógica específica para DiagnosticoCultivosV4
import { computed } from 'vue';
import type { SatelliteImageV4, MonthlySummary, CaptureDetail } from './types-v4';
...
export function useSatelliteImages(diagnosticoData: any) {
    const satelliteImages = computed((): SatelliteImageV4[] => {
        if (!diagnosticoData.value?.satellite_images) return [];
        
        const images: SatelliteImageV4[] = [];
