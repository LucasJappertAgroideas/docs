...
import { DIAGNOSTICO_LOTE_CONFIG_V2 as DIAGNOSTICO_LOTE_CONFIG, getDiagnosticoLoteConfigV2 as getDiagnosticoLoteConfig } from "@/config/diagnosticoLotes";
...
const loteConfig = computed(() => {
    const fieldId = (route.query.field_id as string) || "108"; // Default: Marchetti
...
const pageTitle = computed(() => {
    ...
    return "🌱 Diagnóstico de Cultivos V2";
});
